# Contributing to Svasamm Books

If you are a Svasamm Books user and want to contribute to improving it _without
writing code_, there are several things you can do:

- **Inform us of issues** you face while using Svasamm Books by [raising issues](https://github.com/frappe/books/issues/new).
- **Add a language** you would like to use Svasamm Books in by [contributing translation](https://github.com/frappe/books/wiki/Contributing-Translations).
- **Share your thoughts** on Svasamm Books by joining our [Telegram group](https://t.me/frappebooks).
- **Use Svasamm Books** for your accounting requirements and tell people about it.

---

If you want to contribute code to Svasamm Books, please go through the following sections for tips and guidelines:
...
A few rules of thumb to ensure that you're contributing maintainable code to Svasamm Books:
...
- **Rebase don't merge**: Merge commits are ugly and should be used only to
  merge a large PR.
- **Format your code**: Svasamm Books uses `prettier` and `eslint` rules for code
...
We strive to make Svasamm Books as easy and simple to use as possible, and
